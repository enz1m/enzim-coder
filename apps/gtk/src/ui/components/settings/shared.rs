...
enum LogoutRpcResult {
    LoggedOut,
    ProviderLoggedOut(Option<crate::services::app::runtime::AccountInfo>),
}
...
pub(super) fn build_profile_settings_page(
    ...
    let all_provider_items: Rc<RefCell<Vec<crate::services::app::runtime::AccountProviderInfo>>> =
        Rc::new(RefCell::new(Vec::new()));
    let provider_items: Rc<RefCell<Vec<crate::services::app::runtime::AccountProviderInfo>>> =
        Rc::new(RefCell::new(Vec::new()));
            ...
            let reload_models: Rc<dyn Fn()> = {
                ...
                Rc::new(move || {
                    ...
                    let (tx, rx) = mpsc::channel::<
                        Result<
                            (
                                Vec<crate::services::app::runtime::AccountProviderInfo>,
                                Vec<crate::services::app::runtime::ModelInfo>,
                                HashSet<String>,
                                usize,
                            ),
                            String,
                        ...
                        .try_recv()
                    {
                        Ok(Ok(Some((account_type, email)))) => {
                            ...
                            let _ = crate::ui::components::runtime_auth_dialog::sync_runtime_account_to_db(
                                &db_poll,
                                profile_id,
                                Some(crate::services::app::runtime::AccountInfo {
                                    account_type,
                                    email,
                                }),
                            );
