...
pub(super) struct ApplyRestoreWorkerOutcome {
    pub(super) result: crate::services::app::restore::RestoreApplyResult,
...
pub(super) fn apply_restore_worker(
    ...
    let apply = crate::services::app::restore::apply_restore_to_checkpoint_by_remote_id(
        db,
        codex_thread_id,
        checkpoint_id,
        selected_paths,
...
pub(super) fn undo_restore_worker(
    ...
    let result = crate::services::app::restore::apply_restore_to_checkpoint_by_remote_id(
        db,
        codex_thread_id,
