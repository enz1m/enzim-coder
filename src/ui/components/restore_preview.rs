...
use crate::data::{AppDb, LocalChatTurnRecord};
use crate::restore::{RestoreAction, RestoreCheckpoint, RestorePreview};
...
fn workspace_is_git_backed(workspace_path: &str) -> bool {
    crate::git_exec::run_git_text(Path::new(workspace_path), &["rev-parse", "--show-toplevel"])
